...
class EditIdeaTest extends TestCase
{
    ...
    /** @test */
    public function editing_an_idea_does_not_work_when_user_does_not_have_authorization()
    {
        $user = User::factory()->create();
        $userB = User::factory()->create();
    ...
    /** @test */
    public function editing_an_idea_does_not_work_when_an_hour_has_passed()
    {
        $user = User::factory()->create();
