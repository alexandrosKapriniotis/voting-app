                ...
                <div class="max-w-lg w-full lg:max-w-xs">
                    ...
                    <div class="relative">
                        ...
                        <input
                               wire:model="search"
                               id="search"
                               class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none
                               focus:placeholder-gray-400 focus:border-blue-300 focus:shadow-outline-blue sm:text-sm transition duration-150 ease-in-out"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="w-4/12 px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
