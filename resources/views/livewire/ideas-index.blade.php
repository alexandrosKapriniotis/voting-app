<div>
    <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
        ...
        <div class="w-full">
            <select wire:model="ideas_filter" name="other_filters" id="other_filters" class="w-full rounded-xl border-none px-4 py-2">
        ...
        <div class="w-full md:w-2/3 relative">
            <input wire:model="search" type="search" placeholder="Find an idea" class="placeholder-gray-900 border-none w-full rounded-xl bg-white px-4 py-2 pl-8" />
