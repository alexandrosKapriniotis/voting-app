            ...
            <div class="px-4 py-6 text">
                ...
                <div class="flex items-center space-x-3 mt-8">
                    <a
                        ...
                        href="{{ route('login') }}" class="flex items-center justify-center w-1/2 h-11 text-xs bg-blue
                        font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 text-white">
                        <span class="ml-2">
                            Login
                        </span>
                    ...
                    <a
                        ...
                        href="{{ route('register') }}" class="flex items-center justify-center w-1/2 h-11 text-xs bg-gray-200
